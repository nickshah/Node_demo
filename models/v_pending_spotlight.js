...
module.exports = function(sequelize, DataTypes) {
  return sequelize.define('v_pending_spotlight', {
    spotlight_id: {
    ...
    tableName: 'v_pending_spotlight',
    underscored : true,
    classMethods : {

      getPendingSpotLights : function(  data , success , error  ) {
      ...
      getPendingSpotLightsForCreator : function(  data , success , error  ) {
