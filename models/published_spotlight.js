...
module.exports = function(sequelize, DataTypes) {
  return sequelize.define('published_spotlight', {
    id: {
    ...
    classMethods : {
      ...
      getPublishedSpotlights( success , error ) {
        ...
        try {
          ...
          //Where condition remaining for start time
      ...
      getSpotlightsToMoveIntoHistorical : function( success , error ) {
