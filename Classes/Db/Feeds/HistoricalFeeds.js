...
class HistoricalFeeds {

    constructor( data , model )  {

        if( model != null )
            this.models = model.historical_feeds;
        else
            this.models = server._plugins['hapi-sequelize'].new_tagloy.models.historical_feeds;
        ...
        this.rejected_reason = data.rejected_reason != undefined ? data.rejected_reason : 0 ;
    }
...
module.exports = HistoricalFeeds;