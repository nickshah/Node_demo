...
class PublishedSpotlights {

    constructor(data,model) {

        if( model != null )
            this.models = model.published_spotlight;
        else
            this.models = server._plugins['hapi-sequelize'].new_tagloy.models.published_spotlight;
...
//    Actual operations
    ...
    getSpotlightsForUpload( success , error  ) {

        try {

            this.models.getPublishedSpotlights( function(success_data){
    ...
    getSpotlightsToMoveIntoHistorical( success , error ) {

        try {

            this.models.getSpotlightsToMoveIntoHistorical(function(success_data){
...
module.exports = PublishedSpotlights;