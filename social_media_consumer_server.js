...
server.register([
    ...
    var kafka = require('kafka-node'),
        ...
        consumer = new Consumer(
            client,
            [
                { topic: config.util.kafka_topic, partition: 0 }
            ],
            {
                autoCommit: true
            }
    ...
    consumer.on('message', function (message) {
        ...
        console.log('Message from twitter', message);

        var db_models = server._plugins['hapi-sequelize'].new_tagloy.models;

        var data = JSON.parse(message.value).data;

        console.log('Parsed Data: ', data.entities);


        if(data.extended_tweet != undefined || data.extended_tweet != null)
        {
            if( data.extended_tweet.extended_entities != undefined  && data.extended_tweet.extended_entities != null ) {

                var media = data.extended_tweet.extended_entities.media;
                var media_url = media[0].media_url;
            }
        }
        else if( data.extended_entities != undefined  && data.extended_entities != null ) {
        ...
        async.parallel([
            function(callback) {
                ...
                filter_controller.userTwitterFilter(user_details,function(success_data){
                    ...
                    twt_user_details.social_media_id = 2;

                    var customer_social_media_mapping = new CustomerSocialMediaMapping(twt_user_details,db_models);
                    ...
                    customer_social_media_mapping.checkHandlePresent(function(success_data){
                        ...
                        customer.createRecord(function(success_data){
                            ...
                            var social_media_mapping = {
                                ...
                                handle : user_details.screen_name,
                                social_media_id : 2
                            };
            ...
            function(callback) {
                ...
                {
                    if( data.extended_tweet.entities != undefined  )
                    {
            ...
            if (is_venue_present != false) {
                ...
                var feed_data = {};
                feed_data.feed_msg = (data.extended_tweet != undefined || data.extended_tweet != null) ? data.extended_tweet.full_text : data.text;
                ...
                feed_data.social_media_id = 2;
                feed_data.media_url = media_url;
                ...
                async.waterfall([
                    ...
                    pending_feed.createRecord(function(success_data){
